...
export function SettingsModal({ type, isOpen, onOpenChange, settings, updateSettings, regenerateEdges }: SettingsModalProps) {
    ...
    const descriptions = {
        physics: 'Adjust the real-time physics simulation of the graph.',
        generation: 'Adjust parameters for generating node connections. Requires regeneration.'
    };
